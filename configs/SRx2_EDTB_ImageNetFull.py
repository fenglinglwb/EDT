...
class Config:
    # dataset
    DATASET = edict()
    DATASET.TYPE = 'ImagenetTrainMsDataset'  # ['ImagenetTrainMsDataset', 'FinetuneTrainMsDataset']
    DATASET.DATASETS = ['ImageNet']
    DATASET.SPLITS = ['TRAIN']  # only for imagenet, ['TRAIN', 'VAL']
    DATASET.START_END = [[None, None]]  # only for imagenet, [[None:None], [None,None]]
    ...
    SOLVER.MOMENTUM = 0
    SOLVER.T_PERIOD = [1500000, 2400000, 2700000, 2850000]
    SOLVER.MAX_ITER = 3000001
